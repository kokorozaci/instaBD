/*
„астота конкурсов в мес€ц  - насколько аккаунт активно работает с подписчиками и привлекает новую аудиторию
*/
...
select f_giveaway_frequency_per_month(1308428836);  -- конкурсов в мес€ц
